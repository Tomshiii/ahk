#### *All libs in this dir are not my own and will be credited either in this file, or in the respective folders*
...
`SevenZip.ahk`            => : https://github.com/thqby/ahk2_lib/tree/master/7Zip  
`WebView2.ahk`            => : https://github.com/thqby/ahk2_lib/tree/master/WebView2  
> LICENSE: MIT

<ins>DepthTrawler</ins> & <ins>G33k</ins>  
`pipeCommand.ahk`  => : https://discord.com/channels/115993023636176902/1209347616513720342/1209485394270224406  
> LICENSE: N/A - Freely provided in a discord message
...
`UIA.ahk`          => : https://github.com/Descolada/UIA-v2
> LICENSE: MIT
...
<ins>Spawnova</ins>  
`ShinsImageScanClass.ahk` => : https://github.com/Spawnova/ShinsImageScanClass/blob/main/AHK%20V2/ShinsImageScanClass.ahk  
> LICENSE: MIT

<ins>AHK-just-me</ins>  
`AHK2_LVICE_XXS.ahk` => : https://github.com/AHK-just-me/AHK2_LVICE_XXS/tree/main  
> LICENSE: UNLICENSE
