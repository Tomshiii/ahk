 ...
 * It will then read the users clipboard and if a youtube link is found, download that link with whatever arguments are passed
 *
...
ytDownload(args := "", folder := A_ScriptDir) {
    ...
    if !InStr(A_Clipboard, "https://www.youtube.com/")
        {
