...
class winExt {
    static defaultExclude := "ahk_exe Code.exe|NotifyGUI_"
    /** A wrapper function for `WinGetTitle()` with `regex` as the `TitleMatchMode` and (optionally) `DetectHiddenWindows` set */
    static TitleRegex(WinTitle := "A", WinText:="", ExcludeTitle := this.defaultExclude, ExcludeText:="", dctHidWin := false) {
    ...
    static ClassRegex(WinTitle := "A", WinText:="", ExcludeTitle := this.defaultExclude, ExcludeText:="", dctHidWin := false) {
    ...
    static ActiveRegex(WinTitle := "A", WinText:="", ExcludeTitle := this.defaultExclude, ExcludeText:="", dctHidWin := false) {
    ...
    static ActivateRegex(WinTitle := "A", WinText:="", ExcludeTitle := this.defaultExclude, ExcludeText:="", dctHidWin := false) {
    ...
    static CloseRegex(WinTitle := "A", WinText:="", ExcludeTitle := this.defaultExclude, ExcludeText:="", dctHidWin := false) {
    ...
    static ExistRegex(WinTitle := "A", WinText:="", ExcludeTitle := this.defaultExclude, ExcludeText:="", dctHidWin := false) {
    ...
    static CountRegex(WinTitle := "A", WinText:="", ExcludeTitle := this.defaultExclude, ExcludeText:="", dctHidWin := false) {
    ...
    static PIDRegex(WinTitle := "A", WinText:="", ExcludeTitle := this.defaultExclude, ExcludeText:="", dctHidWin := false) {
    ...
    static ProcessNameRegex(WinTitle := "A", WinText:="", ExcludeTitle := this.defaultExclude, ExcludeText:="", dctHidWin := false) {
    ...
    static ListRegex(WinTitle?, WinText:="", ExcludeTitle := this.defaultExclude, ExcludeText:="", dctHidWin := false) {
    ...
    static WaitCloseRegex(WinTitle := "A", WinText:="", Timeout := 0, ExcludeTitle := this.defaultExclude, ExcludeText:="", dctHidWin := false) {
    ...
    /** A wrapper function for `WinMaximize()` with `regex` as the `TitleMatchMode` and (optionally) `DetectHiddenWindows` set */
    static MaximizeRegex(WinTitle := "A", WinText:="", ExcludeTitle := this.defaultExclude, ExcludeText:="", dctHidWin := false) {
        return this.regexFunc("Maximize", WinTitle, WinText, ExcludeTitle, ExcludeText, dctHidWin)
    }

    static regexFunc(func, WinTitle?, WinText:="", ExcludeTitle := this.defaultExclude, ExcludeText:="", dctHidWin := false, Timeout := 0) {
