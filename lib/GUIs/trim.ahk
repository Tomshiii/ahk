...
class trimGUI extends tomshiBasic {
    ...
    __doTrim(*) {
        ...
        this.durationVal := (this.startVal != 0 && endVal != A_YYYY A_MM A_DD "000000") ? DateDiff(endVal, startVal, "S") : "0"

        if InStr(this.startVal, "-") || InStr(this.durationVal, "-") && this.durationVal != "0" {
