...
;localVer // v2.6
if FileExist(A_ScriptDir "\" forRelease "\Support Files\Icons\myscript.png")
    TraySetIcon(A_ScriptDir "\" forRelease "\Support Files\Icons\myscript.png")
...
replace(*)
{
    ...
    if FileExist(A_ScriptDir "\" forRelease "\lib\KSA\Keyboard Shortcuts.ini")
        releaseIniFile := FileRead(A_ScriptDir "\" forRelease "\lib\KSA\Keyboard Shortcuts.ini")
    else
        {
            ReplacerGui["MyProgress"].Value := 100
            prog.Opt("cRed")
    ...
    if DirExist(A_ScriptDir "\" forRelease "\Backups") && !FileExist(A_ScriptDir "\" forRelease "\Backups\Keyboard Shortcuts.ini")
        FileCopy(A_ScriptDir "\" forRelease "\lib\KSA\Keyboard Shortcuts.ini", A_ScriptDir "\" forRelease "\Backups")
    ...
    FileMove(A_Temp "\tomshi\Keyboard Shortcuts.ini", A_ScriptDir "\" forRelease "\lib\KSA\Keyboard Shortcuts.ini", 1)       
