...
version := (IsSet(premIsBeta) && premIsBeta != true && premIsBeta != "true") ? ptf.PremYearVer ".0" : IniRead(A_WorkingDir "\readme.ini", "INFO", "version")

Dir := A_MyDocuments "\Adobe\Premiere Pro\" version "\Profile-" A_UserName "\Win"
