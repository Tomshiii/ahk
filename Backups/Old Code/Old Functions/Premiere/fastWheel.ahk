...
;// This function was a method of accelorating mouse scrolls using pgup & pgdown that was created while I was having issues with the now in use version of `fastWheel()`
