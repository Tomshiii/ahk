...
if !WinExist("ahk_exe obs64.exe")
	{
		...
		Run(ptf.files["OBS"]) ;opening shortcuts helps to make sure obs and ahk have the same admin level so ahk can interact with it, otherwise obs wont accept inputs
